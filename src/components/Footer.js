        ...
        <div className="newsletter-signup">
          <div className="signup-form-wrapper">
            ...
            <p className="newsletter-terms">
              By submitting your email you agree that GRN may send you
              promotional e-mail messages with offers, updates and other
              marketing messages. You understand that GRN may use your
              information according with its Privacy Policy.
            </p>
          </div>
        </div>
